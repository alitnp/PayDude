...
const article2 = () => {
    return (<article className="article-2-1 col-xs-12">
        ...
        <div className="detail col-xs-12 col-m-7 col-l-6">
            <div className="">
                ...
                <p className="">
                    پرداخت هزینه آزمون های مختلف از جمله آزمون PTE و Toefl <br />
                پرداخت و خرید کالا از سایت هایی که کالا به ایران میفرستند <br />
